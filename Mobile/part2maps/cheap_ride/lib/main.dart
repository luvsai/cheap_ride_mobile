...
import 'Views/AccountCreationScreen.dart';
import 'Views/HomeScreens.dart';
import 'features/trip/views/routeSD.dart';
import 'utility.dart' ;
import './Views/SplashScreen.dart' ;
import './Views/LoginScreens.dart';
...
Widget initialize(BuildContext context,MediaQueryData mediaQueryData){
  ...
  // return SplashScr();
  // return ACC(Ph: "8019616883",);
  // return Home();// change back to this

  // return MapScreen(
  //   source: LatLng(12.932362, 77.705302), // Example source coordinate
  //   destination:LatLng(12.942200, 77.698200), // Example destination coordinate
  // );


  // return VerifyOTP(Ph: "8019616883",) ;
  return SendOTP();
